...
def is_cached(file_path):
    ...
    if file_age > 0 and is_connected():  # 86400
...
def read_csv(exchange):
    ...
    exchange_file = csv.DictReader(open(str(file_path)), fieldnames=['symbol', 'company', 'LastSale', 'MarketCap', 'ADR TSO', 'IPOyear', 'sector', 'industry', 'Summary Quote', ''])
